...
#otp_path = r"C:\HY-DATA\hentenka\KOODIT\Mapple\mrouter\bin\otp-1.3.0-shaded.jar"
...
conf_fp = os.path.join(data_dir, 'config.json')
#conf_fp = os.path.join(data_dir, 'config_2.json')
#origs_fp = os.path.join(base_dir, 'validation', 'validation_sample_100_points.geojson')
origs_fp = os.path.join(base_dir, 'validation', 'validation_sample_100_points.csv')
dests_fp = origs_fp
name = "OTP_results_for_validation_Jan_29_2018_rush_hour_otm"
orig_id = 'ID'
dest_id = 'ID'
